...
class UnarchiveNoteImplTest {
    ...
    @InjectMocks
    private UnarchiveNoteImpl unarchiveNoteUseCase;

    @Test
    void shouldUnarchiveNoteSuccessfully() {
        // Arrange
    ...
    void shouldThrowResourceNotFoundExceptionWhenNoteDoesNotBelongToProject() {
        ...
        UUID noteId = UUID.randomUUID();
        Note note = new Note(noteId, otherProjectId, "Title", "Content", true);
